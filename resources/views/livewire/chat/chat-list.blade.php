<div x-data="{type:'all',query:@entangle('query')}" x-init="
    ...
    <header class="px-3 z-10 bg-white sticky top-0 w-full py-2">
        ...
        <div class="flex items-center gap-3 overflow-x-scroll p-2 bg-white">
            ...
            <button @click="type='friend'" :class="{'bg-blue-100 border-0 text-black':type=='friend'}"
                class="inline-flex justify-center items-center rounded-full gap-x-1 text-xs font-medium px-3 lg:px-5 py-1 lg:py-2.5 border">
                Bạn bè
            </button>
        </div>
        ...
        <ul class="p-2 grid w-full space-y-2">
            ...
            <li id="conversation-{{$conversation->id}}" wire:key="{{$conversation->id}}"
                ...
                <a href="#" class="shrink-0 w-12 h-12">
                    <img src="https://randomuser.me/api/portraits/women/{{$key}}.jpg" alt="image"
                ...
                <aside class="grid grid-cols-12 w-full">
                    ...
                    <div class="col-span-1 flex flex-col text-center my-auto z-30">
                        <div align="right" width="48">
                            <button>
                                <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor"
                                    class="bi bi-three-dots-vertical w-5 h-5 text-gray-700" viewBox="0 0 16 16">
                                    <path
