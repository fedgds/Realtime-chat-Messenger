    ...
    <div class="border-b flex flex-col overflow-y-scroll grow h-full">
        ...
        <header class="w-full sticky inset-x-0 flex pb-[5px] pt-[5px] top-0 z-10 bg-white border-b " >
            <div class="flex w-full items-center px-2 lg:px-4 gap-2 md:gap-5">
                ...
                <h6 class="font-bold truncate"> La Sang </h6>
            </div>
        </header>
        {{-- body --}}
            ...
            <div @class([
                ...
                <div @class(['flex flex-wrap text-[15px]  rounded-xl p-2.5 flex flex-col text-black bg-[#f6f6f8fb]',
                    ...
                    <p class="whitespace-normal truncate text-sm md:text-base tracking-wide lg:tracking-normal">
                        Lorem ipsum, dolor sit amet consectetur adipisicing elit. Aliquid aperiam esse placeat eius numquam deserunt 
                    </p>
            ...
            <div class=" p-2 border-t">
                <form action="POST" autocapitalize="off">
                    ...
                    <div class="grid grid-cols-12">
                        ...
                        <button class="col-span-2" type='submit'>Gửi</button>
